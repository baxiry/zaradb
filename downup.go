...
func mainc() {
	deploy("lilgo", "139.162.118.190", "d7ombot123")
	//deploy("test", "158.247.195.235", "e1J=xHytspxhhscx")

	os.Exit(1)
	saver("test", "158.247.195.235", "e1J=xHytspxhhscx")
...
//
func saver(foldname, address, pass string) {

	//sshpass -p "password" scp -r user@example.com:/some/remote/path /some/local/path
	cmd := exec.Command("sshpass", "-p", pass, "scp", "-r", "root@"+address+":/root/"+foldname, "/root/") //.Output()
